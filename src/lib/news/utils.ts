...
export const validateCategory = (categoryName: string | null) => {
  ...
  const validCategories = [
    'general', 'technology', 'science', 'business', 'politics', 'world',
    'health', 'entertainment', 'sports', 'geopolitics', 'defense', 'military',
    'security', 'economy', 'finance', 'education', 'environment', 'climate',
    'travel', 'culture', 'arts', 'music', 'film', 'books', 'food', 'lifestyle',
    'fashion', 'gaming', 'video games'
  ];

  const upperCategory = categoryName.toLowerCase();
