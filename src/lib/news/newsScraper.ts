...
export const getCategorizedNews = async (category: string): Promise<Article[]> => {
  ...
  const categoryMapping: { [key: string]: string[] } = {
    ...
    'defense': ['DEF-INDIANEXPRESS', 'DEF-THEHINDU', 'DEF-HT', 'DEF-ND', 'DEF-BS', 'DEF-HAL', 'DEF-MAZAGON', 'DEF-USDOD', 'DEF-USARMY', 'DEF-USNAVY', 'DEF-USAF', 'DEF-USMARINE', 'DEF-FRANCEARMY', 'DEF-GERMANYARMY', 'DEF-JAPANARMY', 'DEF-SOUTHKOREAARMY', 'DEF-AUSTRALIAARMY', 'DEF-CANADAARMY', 'DEF-BRAZILARMY', 'DEF-TURKEYARMY', 'DEF-SAUDIARMY', 'DEF-UAEARMY', 'DEF-EGYPTARMY', 'DEF-IRANARMY', 'DEF-NORTHKOREAARMY', 'DEF-SINGAPOREARMY', 'DEF-THAILANDARMY', 'DEF-PHILIPPINESARMY', 'DEF-INDONESIAARMY', 'DEF-VIETNAMARMY', 'DEF-MALAYSIAARMY', 'DEF-NEWZEALANDARMY', 'DEF-SOUTHKOREAARMYHQ', 'DEF-JAPANGSDFHQ', 'DEF-JAPANMSDFHQ', 'DEF-JAPANASDFHQ', 'DEF-TURKEYARMYHQ', 'DEF-IRANARMYHQ', 'DEF-BRAZILARMYHQ', 'DEF-MEXICOARMYHQ', 'DEF-AUSTRALIAARMYHQ', 'DEF-CANADAARMYHQ', 'DEF-INDONESIAHQ', 'DEF-THAILANDHQ', 'DEF-PHILIPPINESHQ', 'DEF-VIETNAMHQ', 'DEF-MALAYSIAHQ', 'DEF-NEWZEALANDHQ', 'DEF-NATO', 'DEF-EU', 'DEF-UN', 'DEF-OSCE', 'DEF-ARAB', 'DEF-ASEAN', 'DEF-SAARC', 'DEF-BRICS', 'DEF-SCO', 'DEF-QUAD', 'DEF-AUKUS', 'DEF-FIVE', 'DEF-G7', 'DEF-G20', 'DEF-PAKISTAN', 'DEF-PAKARMY', 'DEF-PAKNAVY', 'DEF-PAKAF', 'DEF-CHINA', 'DEF-CHINAARMY', 'DEF-RUSSIA', 'DEF-RUSSIANARMY', 'DEF-UKMOD', 'DEF-UKARMY', 'DEF-UKROYALNAVY', 'DEF-UKRAF', 'DEF-ISRAEL', 'DEF-ISRAELIDF'],
    'stock': ['STOCK-BUSINESSSTANDARD', 'STOCK-MONEYCONTROL', 'STOCK-ECONOMICTIMES', 'STOCK-BSE', 'STOCK-NSE', 'STOCK-ZEEBUSINESS', 'STOCK-LIVEMINT', 'STOCK-INDIANEXPRESSFINANCE', 'STOCK-HTFINANCE', 'STOCK-ND', 'STOCK-BUSINESSLINE', 'STOCK-FINANCIALEXPRESS', 'STOCK-BLOOMBERG', 'STOCK-REUTERSFINANCE', 'STOCK-CNBC', 'STOCK-FORBES', 'STOCK-WSJ', 'STOCK-FT', 'STOCK-YAHOOFINANCE', 'STOCK-INVESTING', 'STOCK-MARKETWATCH', 'STOCK-CNNMONEY', 'STOCK-SEEKINGALPHA', 'STOCK-NASDAQ', 'STOCK-NYSE'],
