...
export const getCategorizedNews = async (category: string): Promise<Article[]> => {
  ...
  const categoryMapping: { [key: string]: string[] } = {
    ...
    'sports': ['SPORT-ESPN', 'SPORT-BBCSPORT', 'SPORT-THEATHLETIC', 'SPORT-SKYSPORTS', 'SPORT-FOXSPORTS', 'SPORT-CRICBUZZ', 'SPORT-ESPNCRIC', 'SPORT-INDIANEXPRESSSPORTS'],
    ...
    'stock': ['STOCK-BLOOMBERG', 'STOCK-REUTERSFINANCE', 'STOCK-CNBC', 'STOCK-FORBES', 'STOCK-WSJ', 'STOCK-FT', 'STOCK-BUSINESSSTANDARD', 'STOCK-MONEYCONTROL', 'STOCK-ECONOMICTIMES'],
