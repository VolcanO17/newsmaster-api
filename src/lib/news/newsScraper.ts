...
export const getCategorizedNews = async (category: string): Promise<Article[]> => {
  ...
  const categoryMapping: { [key: string]: string[] } = {
    ...
    'sports': ['SPORT-CRICBUZZ', 'SPORT-ESPNCRIC', 'SPORT-INDIANEXPRESSSPORTS', 'SPORT-TOISPORTS', 'SPORT-HTSPORTS', 'SPORT-INDIATODAYSPORTS', 'SPORT-ZEENEWS', 'SPORT-INDIANSPORTS', 'SPORT-ESPN', 'SPORT-BBCSPORT', 'SPORT-THEATHLETIC', 'SPORT-SKYSPORTS', 'SPORT-FOXSPORTS', 'SPORT-NFL', 'SPORT-PREMIERLEAGUE', 'SPORT-FIFA', 'SPORT-TENNIS', 'SPORT-GOLF'],
    ...
    'stock': ['STOCK-BLOOMBERG', 'STOCK-REUTERSFINANCE', 'STOCK-CNBC', 'STOCK-FORBES', 'STOCK-WSJ', 'STOCK-FT', 'STOCK-BUSINESSSTANDARD', 'STOCK-MONEYCONTROL', 'STOCK-ECONOMICTIMES', 'STOCK-YAHOOFINANCE', 'STOCK-INVESTING', 'STOCK-MARKETWATCH', 'STOCK-CNNMONEY', 'STOCK-SEEKINGALPHA'],
