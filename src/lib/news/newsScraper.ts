...
export const getCategorizedNews = async (category: string): Promise<Article[]> => {
  ...
  const categoryMapping: { [key: string]: string[] } = {
    'general': ['IN-TOI', 'IN-HT', 'IN-IE', 'IN-NDTV', 'US-CNN', 'US-NYT', 'US-R', 'AU-ABC', 'CA-CBCN', 'UK-BBC', 'UK-GU', 'DE-DW', 'FRANCE24', 'BBCWORLD'],
    'technology': ['TECH-TECHCRUNCH', 'TECH-ARSTECHNICA', 'TECH-THENEXTWEB', 'TECH-ENGADGET', 'TECH-GIZMODO', 'TECH-TECHREPUBLIC', 'TECH-ZDNET', 'TECH-CNET', 'TECH-INDIANEXPRESS TECH'],
    'science': ['SCI-NASA', 'SCI-SCIENCEDAILY', 'SCI-NATURE', 'SCI-SCIENCENEWS', 'SCI-SCIENCEMAG', 'SCI-NEWSCIENTIST', 'SCI-PHYSORG', 'SCI-LIVESCIENCE', 'SCI-SPACE', 'SCI-ISRO'],
    'business': ['IN-BS', 'US-CNN', 'US-NYT', 'CA-FP', 'US-R', 'AU-BN', 'CA-NP'],
    'sports': ['SPORT-CRICBUZZ', 'SPORT-ESPNCRIC', 'SPORT-INDIANEXPRESSSPORTS', 'SPORT-TOISPORTS', 'SPORT-HTSPORTS', 'SPORT-INDIATODAYSPORTS', 'SPORT-ZEENEWS', 'SPORT-INDIANSPORTS', 'SPORT-STARSPORTS', 'SPORT-SONYSPORTS', 'SPORT-DDSPORTS', 'SPORT-AIRTS', 'SPORT-INDIANSOCIAL', 'SPORT-ESPN', 'SPORT-BBCSPORT', 'SPORT-THEATHLETIC', 'SPORT-SKYSPORTS', 'SPORT-FOXSPORTS', 'SPORT-NFL', 'SPORT-PREMIERLEAGUE', 'SPORT-FIFA', 'SPORT-TENNIS', 'SPORT-GOLF'],
    ...
    'defense': ['DEF-INDIANEXPRESS', 'DEF-THEHINDU', 'DEF-HT', 'DEF-ND', 'DEF-BS', 'DEF-HAL', 'DEF-MAZAGON', 'DEF-DRDO', 'DEF-INDIANARMY', 'DEF-INDIANNAVY', 'DEF-INDIANAIRFORCE', 'DEF-MODINDIA', 'DEF-TOIDEFENCE', 'DEF-ECONOMICTIMESDEF', 'DEF-FINANCIALEXPRESSDEF', 'DEF-LIVEMINTDEF', 'DEF-BUSINESSLINEDEF', 'DEF-DECCANHERALDDEF', 'DEF-NEWINDIANEXPRESSDEF', 'DEF-ASIANAGEDEF', 'DEF-PIONEERDEF', 'DEF-TRIBUNEDEF', 'DEF-HINDUSTANDEF', 'DEF-ZEENEWSDEF', 'DEF-ABPNLIVEDEF', 'DEF-INDIATODAYDEF', 'DEF-AJTAKDEF', 'DEF-REPUBLICDEF', 'DEF-ONEINDIADEF', 'DEF-GREATANDHRADef', 'DEF-SAKSHIDEF', 'DEF-EENADUDEF', 'DEF-ANDHRAPRAVADef', 'DEF-MAHARASHTRADEF', 'DEF-BENGALDEF', 'DEF-GUJARATDEF', 'DEF-RAJASTHANDEF', 'DEF-PUNJABDEF', 'DEF-HARYANADEF', 'DEF-UPDEF', 'DEF-MPDEF', 'DEF-KARNATAKADEF', 'DEF-TAMILNADUDEF', 'DEF-KERALADef', 'DEF-DELHIDEF', 'DEF-JAMMUDEF', 'DEF-LADAKHDEF', 'DEF-GOADEF', 'DEF-PONDI_DEF', 'DEF-CHANDIGARHDEF', 'DEF-DAMANDEF', 'DEF-DIUDEF', 'DEF-DADRADEF', 'DEF-NAGARDEF', 'DEF-LAKSHADWEEPDEF', 'DEF-ANDAMANDEF', 'DEF-NICOBARDEF', 'DEF-SIKKIMDEF', 'DEF-ARUNACHALDEF', 'DEF-NAGALANDDEF', 'DEF-MANIPURDEF', 'DEF-MIZORAMDEF', 'DEF-TRIPURADEF', 'DEF-MEGHALAYADEF', 'DEF-ASSAMDEF', 'DEF-WESTBENGALDEF', 'DEF-JHARKHANDDEF', 'DEF-ODISHADEF', 'DEF-CHHATTISGARHDEF', 'DEF-BIHARDEF', 'DEF-UTTARAKHANDDEF', 'DEF-HIMACHALDEF', 'DEF-PUDUCHERRYDEF', 'DEF-CHANDIGARHDEF2', 'DEF-LADAKHDEF2', 'DEF-JAMMUDEF2', 'DEF-KASHMIRDEF', 'DEF-SRILANKADEF', 'DEF-NEPALDEF', 'DEF-BHUTANDEF', 'DEF-BANGLADESHDEF', 'DEF-MYANMARDEF', 'DEF-THAILANDDEF', 'DEF-CAMBODIADEF', 'DEF-LAOSDEF', 'DEF-VIETNAMDEF', 'DEF-MALAYSIADEF', 'DEF-SINGAPOREDEF', 'DEF-INDONESIADEF', 'DEF-PHILIPPINESDEF', 'DEF-JAPANDEF', 'DEF-SOUTHKOREADEF', 'DEF-AUSTRALIADEF', 'DEF-NEWZEALANDDEF', 'DEF-CANADEF', 'DEF-UKDEF', 'DEF-FRANCEDEF', 'DEF-GERMANYDEF', 'DEF-CHINADEF', 'DEF-RUSSIADEF', 'DEF-PAKISTANDEF', 'DEF-IRANDEF', 'DEF-SAUDIDEF', 'DEF-UAEDEF', 'DEF-TURKEYDEF', 'DEF-ISRAELDEF', 'DEF-EGYPTDEF', 'DEF-NIGERIADEF', 'DEF-SOUTHAFRICADEF', 'DEF-BRAZILDEF', 'DEF-MEXICODEF', 'DEF-ARGENTINADEF', 'DEF-CHILEDEF', 'DEF-COLOMBIADEF', 'DEF-PERUDEF', 'DEF-VENEZUELADEF', 'DEF-ECUADORDEF', 'DEF-BOLIVIADEF', 'DEF-PARAGUAYDEF', 'DEF-URUGUAYDEF', 'DEF-GUYANADEF', 'DEF-SURINAMEDEF', 'DEF-FRENCHGUIANADEF', 'DEF-BARBADOSDEF', 'DEF-TRINIDADDEF', 'DEF-JAMAICADEF', 'DEF-HAITIDEF', 'DEF-DOMINICANDEF', 'DEF-CUBADef', 'DEF-BAHAMASDEF', 'DEF-BELIZEDEF', 'DEF-COSTARICADEF', 'DEF-ELSALVADORDEF', 'DEF-GUATEMALADEF', 'DEF-HONDURASDEF', 'DEF-NICARAGUADEF', 'DEF-PANAMADEF', 'DEF-ALBANIADEF', 'DEF-ARMENIADEF', 'DEF-AZERBAIJANDEF', 'DEF-BELARUSDEF', 'DEF-BOSNIADEF', 'DEF-BULGARIADEF', 'DEF-CROATIADEF', 'DEF-CZECHDEF', 'DEF-ESTONIADEF', 'DEF-FINLANDDEF', 'DEF-GEORGIADEF', 'DEF-GREECEDEF', 'DEF-HUNGARYDEF', 'DEF-ICELANDDEF', 'DEF-KAZAKHSTANDEF', 'DEF-KYRGYZSTANDEF', 'DEF-LATVIADEF', 'DEF-LITHUANIADEF', 'DEF-LUXEMBOURGDEF', 'DEF-MOLDOVADEF', 'DEF-MONTENEGRODEF', 'DEF-NETHERLANDSDEF', 'DEF-NORTHMACEDONIADEF', 'DEF-NORWAYDEF', 'DEF-POLANDDEF', 'DEF-PORTUGALDEF', 'DEF-ROMANIADEF', 'DEF-SERBIADEF', 'DEF-SLOVAKIADEF', 'DEF-SLOVENIADEF', 'DEF-SPAINDEF', 'DEF-SWEDENDEF', 'DEF-SWITZERLANDDEF', 'DEF-TAJIKISTANDEF', 'DEF-TURKMENISTANDEF', 'DEF-UKRAINEDEF', 'DEF-UZBEKISTANDEF', 'DEF-ALGERIADEF', 'DEF-MOROCCODEF', 'DEF-TUNISIADEF', 'DEF-LIBYADEF', 'DEF-ETHIOPIADEF', 'DEF-KENYADEF', 'DEF-UGANDADEF', 'DEF-TANZANIADEF', 'DEF-GHANADef', 'DEF-SENEGALDEF', 'DEF-COTEIVOIREDEF', 'DEF-NAMIBIADEF', 'DEF-BOTSWANADEF', 'DEF-ZAMBIADEF', 'DEF-ZIMBABWEDEF', 'DEF-MOZAMBIQUEDEF', 'DEF-ANGOLADEF', 'DEF-MALAWI_DEF', 'DEF-MADAGASCARDEF', 'DEF-MAURITIUSDEF', 'DEF-SEYCHELLESDEF', 'DEF-COMOROSDEF', 'DEF-DJIBOUTIDEF', 'DEF-SOMALIADEF', 'DEF-SUDANDEF', 'DEF-CHADDEF', 'DEF-NIGERDEF', 'DEF-MALIDEF', 'DEF-BURKINAFASODEF', 'DEF-GUINEADEF', 'DEF-SIERRADEF', 'DEF-LIBERIADEF', 'DEF-GAMBIADEF', 'DEF-GUINEABISSAUDEF', 'DEF-CABOVERDEDEF', 'DEF-SAHARADEF', 'DEF-JDN', 'DEF-DN', 'DEF-AF', 'DEF-ARMY', 'DEF-NAVY', 'DEF-MARINE', 'DEF-AIRFORCE', 'DEF-BREAKING', 'DEF-NATIONAL', 'DEF-MILITARY', 'DEF-STRATFOR', 'DEF-JANES', 'DEF-GLOBAL', 'DEF-ASPI', 'DEF-RUSI', 'DEF-IISS', 'DEF-CSIS', 'DEF-RAND', 'DEF-BROOKINGS', 'DEF-CFR', 'DEF-HERITAGE', 'DEF-CATO', 'DEF-AEI', 'DEF-IDSA', 'DEF-ORF', 'DEF-CIP', 'DEF-SIPRI', 'DEF-ACADEMY', 'DEF-NAVAL', 'DEF-AIR', 'DEF-COAST', 'DEF-SPACE', 'DEF-CYBER', 'DEF-DOD', 'DEF-PENTAGON', 'DEF-OSD', 'DEF-JOINT', 'DEF-ARMYHQ', 'DEF-NAVYHQ', 'DEF-AFHQ', 'DEF-MARINEHQ', 'DEF-COASTHQ', 'DEF-SPACEHQ', 'DEF-NATO', 'DEF-EU', 'DEF-UN', 'DEF-OSCE', 'DEF-ARAB', 'DEF-ASEAN', 'DEF-SAARC', 'DEF-BRICS', 'DEF-SCO', 'DEF-QUAD', 'DEF-AUKUS', 'DEF-FIVE', 'DEF-G7', 'DEF-G20', 'DEF-PAKISTAN', 'DEF-PAKARMY', 'DEF-PAKNAVY', 'DEF-PAKAF', 'DEF-CHINA', 'DEF-CHINAARMY', 'DEF-RUSSIA', 'DEF-RUSSIANARMY', 'DEF-UKMOD', 'DEF-UKARMY', 'DEF-UKROYALNAVY', 'DEF-UKRAF', 'DEF-FRANCE', 'DEF-GERMANY', 'DEF-JAPAN', 'DEF-SOUTHKOREA', 'DEF-ISRAEL', 'DEF-ISRAELIDF', 'DEF-SAUDI', 'DEF-UAE', 'DEF-TURKEY', 'DEF-IRAN', 'DEF-NORTHKOREA', 'DEF-BRAZIL', 'DEF-MEXICO', 'DEF-AUSTRALIA', 'DEF-CANADA', 'DEF-SOUTHKOREAARMY', 'DEF-JAPANGSDF', 'DEF-JAPANMSDF', 'DEF-JAPANASDF', 'DEF-TURKEYARMY', 'DEF-IRANARMY', 'DEF-BRAZILARMY', 'DEF-MEXICOARMY', 'DEF-AUSTRALIAARMY', 'DEF-CANADAARMY', 'DEF-INDONESIA', 'DEF-THAILAND', 'DEF-SINGAPORE', 'DEF-PHILIPPINES', 'DEF-VIETNAM', 'DEF-MALAYSIA', 'DEF-NEWZEALAND', 'DEF-SOUTHKOREAARMYHQ', 'DEF-JAPANGSDFHQ', 'DEF-JAPANMSDFHQ', 'DEF-JAPANASDFHQ', 'DEF-TURKEYARMYHQ', 'DEF-IRANARMYHQ', 'DEF-BRAZILARMYHQ', 'DEF-MEXICOARMYHQ', 'DEF-AUSTRALIAARMYHQ', 'DEF-CANADAARMYHQ', 'DEF-INDONESIAHQ', 'DEF-THAILANDHQ', 'DEF-SINGAPOREHQ', 'DEF-PHILIPPINESHQ', 'DEF-VIETNAMHQ', 'DEF-MALAYSIAHQ', 'DEF-NEWZEALANDHQ', 'DEF-BULGARIA', 'DEF-CROATIA', 'DEF-CZECH', 'DEF-ESTONIA', 'DEF-FINLAND', 'DEF-GREECE', 'DEF-HUNGARY', 'DEF-ICELAND', 'DEF-LATVIA', 'DEF-LITHUANIA', 'DEF-LUXEMBOURG', 'DEF-NETHERLANDS', 'DEF-NORWAY', 'DEF-POLAND', 'DEF-PORTUGAL', 'DEF-ROMANIA', 'DEF-SLOVAKIA', 'DEF-SLOVENIA', 'DEF-SPAIN', 'DEF-SWEDEN', 'DEF-SWITZERLAND', 'DEF-UKRAINE', 'DEF-ALBANIA', 'DEF-ARMENIA', 'DEF-AZERBAIJAN', 'DEF-BELARUS', 'DEF-BOSNIA', 'DEF-GEORGIA', 'DEF-KAZAKHSTAN', 'DEF-KYRGYZSTAN', 'DEF-MOLDOVA', 'DEF-MONTENEGRO', 'DEF-NORTHMACEDONIA', 'DEF-SERBIA', 'DEF-TAJIKISTAN', 'DEF-TURKMENISTAN', 'DEF-UZBEKISTAN', 'DEF-EGYPT', 'DEF-ALGERIA', 'DEF-MOROCCO', 'DEF-TUNISIA', 'DEF-LIBYA', 'DEF-NIGERIA', 'DEF-ETHIOPIA', 'DEF-KENYA', 'DEF-UGANDA', 'DEF-TANZANIA', 'DEF-GHANA', 'DEF-SENEGAL', 'DEF-COTEIVOIRE', 'DEF-NAMIBIA', 'DEF-BOTSWANA', 'DEF-ZAMBIA', 'DEF-ZIMBABWE', 'DEF-MOZAMBIQUE', 'DEF-ANGOLA', 'DEF-MALAWI', 'DEF-MADAGASCAR', 'DEF-MAURITIUS', 'DEF-SEYCHELLES', 'DEF-COMOROS', 'DEF-DJIBOUTI', 'DEF-SOMALIA', 'DEF-SUDAN', 'DEF-CHAD', 'DEF-NIGER', 'DEF-MALI', 'DEF-BURKINA', 'DEF-GUINEA', 'DEF-SIERRA', 'DEF-LIBERIA', 'DEF-GAMBIA', 'DEF-GUINEABISSAU', 'DEF-CABOVERDE', 'DEF-SAHARA', 'DEF-MONGOLIA', 'DEF-NEPAL', 'DEF-BHUTAN', 'DEF-BANGLADESH', 'DEF-SRILANKA', 'DEF-MYANMAR', 'DEF-CAMBODIA', 'DEF-LAOS', 'DEF-TIMOR', 'DEF-PAPUA'],
    'stock': ['STOCK-BLOOMBERG', 'STOCK-REUTERSFINANCE', 'STOCK-CNBC', 'STOCK-FORBES', 'STOCK-WSJ', 'STOCK-FT', 'STOCK-BUSINESSSTANDARD', 'STOCK-MONEYCONTROL', 'STOCK-ECONOMICTIMES', 'STOCK-YAHOOFINANCE', 'STOCK-INVESTING', 'STOCK-MARKETWATCH', 'STOCK-CNNMONEY', 'STOCK-SEEKINGALPHA', 'STOCK-NASDAQ', 'STOCK-NYSE', 'STOCK-BSE', 'STOCK-NSE', 'STOCK-ZEEBUSINESS', 'STOCK-LIVEMINT', 'STOCK-INDIANEXPRESSFINANCE', 'STOCK-HTFINANCE', 'STOCK-ND', 'STOCK-BUSINESSLINE', 'STOCK-FINANCIALEXPRESS', 'DEF-BS', 'DEF-ECONOMICTIMESDEF', 'DEF-FINANCIALEXPRESSDEF', 'DEF-BUSINESSLINEDEF', 'DEF-DN', 'DEF-BREAKING', 'DEF-NATIONAL', 'DEF-BROOKINGS', 'DEF-CFR', 'DEF-HERITAGE', 'DEF-CATO', 'DEF-AEI', 'DEF-ORF', 'DEF-DOD', 'DEF-OSD', 'DEF-ARAB', 'DEF-ASEAN', 'DEF-SAARC', 'DEF-BRICS', 'DEF-G7', 'DEF-G20', 'DEF-CHINA', 'DEF-SOUTHKOREA', 'DEF-ISRAELIDF', 'DEF-MEXICO', 'DEF-JAPANGSDF', 'DEF-JAPANMSDF', 'DEF-JAPANASDF', 'DEF-PHILIPPINES', 'DEF-ICELAND'],
